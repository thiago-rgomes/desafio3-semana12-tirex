...
const Section2 = () => {
  return (
    <div className='flex flex-col items-center w-full h-auto py-[56px]'>
        <div className='pb-[48px]'>
            <h2 className='text-center font-bold text-[32px] text-[#333333]'>Browse the Range</h2>
            <p className='text-center text-[20px] text-[#666666]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </div>

        <div className='flex  gap-[20px] '>
            <div className='flex flex-col justify-center items-center gap-[30px]'>
                <img src={diningImg} alt="dinning image" className='w-[381px] h-[480px] rounded-md' />
                <p className='font-semibold text-[24px] text-[#333333]'>Dining</p>
            </div>
            <div className='flex flex-col justify-center items-center gap-[30px]'>
                <img src={livingImg} alt="dinning image" className='w-[381px] h-[480px] rounded-md' />
                <p className='font-semibold text-[24px] text-[#333333]'>Living</p>
            </div>
            <div className='flex flex-col justify-center items-center gap-[30px]'>
                <img src={bedroomImg} alt="dinning image" className='w-[381px] h-[480px] rounded-md' />
